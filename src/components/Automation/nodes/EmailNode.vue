<template>
      ...
      <div class="node-content">
        ...
        <div class="field-group">
          ...
          <div class="input-wrapper">
            <input 
              ...
              @input="updateField('emailSubject', $event.target.value)"
        ...
        <div class="field-group">
          ...
          <div class="input-wrapper">
            <input 
              type="text" 
              :value="data.emailTo" 
              @input="updateField('emailTo', $event.target.value)"
        ...
        <div class="field-group">
          ...
          <div class="input-wrapper">
            <input 
              type="text" 
              :value="data.emailCC" 
              @input="updateField('emailCC', $event.target.value)"
        ...
        <div class="field-group">
          ...
          <textarea
            ...
            @input="updateField('emailBody', $event.target.value)"
  ...
  input:focus, .email-textarea:focus {
    outline: none;
    border-color: #3B82F6;
    background: white;
